...
namespace cpp::crc
{
    ...
    constexpr u32 crc32(const char* str, const u64 len, const u32 prev_crc = 0xFFFFFFFF)
    {
        u32 crc = prev_crc;
        for (u64 i = 0; i < len; ++i)
        {
    ...
    constexpr u64 crc64(const char* str, const u64 len, const u64 prev_crc = 0xFFFFFFFFFFFFFFFFULL)
    {
        u64 crc = prev_crc;
        for (u64 i = 0; i < len; ++i)
        {
